...
public sealed class RegelIdeDbContext(DbContextOptions<RegelIdeDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        b.Entity<RettskildeEntitet>(e =>
        {
            ...
            // Kun én 'gjeldende' rad per ELI av gangen (partial unique index, §2 kommentar i teknisk design)
        ...
        b.Entity<TekstTaggEntitet>(e =>
        {
            ...
            e.HasIndex(x => new { x.RettskildeId, x.NodeEid, x.StartOffset, x.EndOffset, x.Kind, x.RefId })
